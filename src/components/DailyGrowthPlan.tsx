...
Format your response as JSON with this exact structure:
{
  ...
  return (
    <div className="bg-white shadow rounded-lg p-6">
      <div className="mb-6">
        <h3 className="text-lg font-medium text-gray-900 mb-2">AI Daily Growth Plan</h3>
      ...
      {!dataLoading && (
        <div className="mb-6 p-4 bg-gray-50 rounded-lg">
          <h4 className="text-sm font-medium text-gray-700 mb-3">Your Current Stats</h4>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
            <div>
              <span className="text-gray-500">Leads:</span>
              <span className="ml-2 font-medium">{userData.totalLeads}</span>
            </div>
            <div>
              <span className="text-gray-500">Contacts:</span>
              <span className="ml-2 font-medium">{userData.totalContacts}</span>
            </div>
            <div>
              <span className="text-gray-500">Sequences:</span>
              <span className="ml-2 font-medium">{userData.totalSequences}</span>
            </div>
            <div>
              <span className="text-gray-500">Revenue:</span>
              <span className="ml-2 font-medium">${userData.weeklyRevenue.toFixed(2)}</span>
            </div>
            <div>
              <span className="text-gray-500">Conversion:</span>
              <span className="ml-2 font-medium">{userData.conversionRate.toFixed(1)}%</span>
            </div>
            <div>
              <span className="text-gray-500">Recent Activity:</span>
              <span className="ml-2 font-medium">{userData.recentActivity}</span>
            </div>
          </div>
        </div>
      )}
      ...
      {actions.length > 0 && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h4 className="text-md font-medium text-gray-900">Today's Action Items</h4>
            <button
