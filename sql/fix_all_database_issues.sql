...
-- 5. Fix automations table - update type constraint to allow new values
DO $$ 
BEGIN
  ...
  -- Add new constraint with all allowed types
...
-- 9. Fix user_settings unique constraint and upsert behavior
DO $$ 
BEGIN
