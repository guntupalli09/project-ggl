-- Email System Setup with Important Columns
...
-- ========================================
-- STEP 9: Insert Default Templates with Niche and Business Type
-- ========================================
...
('Med Spa Treatment Plan', 'healthcare', 'medspa', 'treatment_plan',
 ...
 TRUE, '{"customer_name", "treatment_1", "treatment_2", "treatment_3", "booking_link", "contact_link", "provider_name", "business_name"}'),
...
('Real Estate Open House', 'real_estate', 'realestate', 'open_house',
 ...
 TRUE, '{"customer_name", "property_address", "open_house_date", "open_house_time", "property_price", "contact_link", "agent_name", "business_name"}'),
...
('Home Services Maintenance Reminder', 'home_services', 'homeservices', 'maintenance_reminder',
 ...
 TRUE, '{"customer_name", "service", "business_name", "booking_link", "contact_link"}'),
