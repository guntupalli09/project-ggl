...
-- This script adds missing columns to the existing email_templates table

-- ========================================
-- STEP 1: Add missing columns to email_templates
-- ========================================
...
-- ========================================
-- STEP 2: Update existing records to have proper name values
-- ========================================

-- If name is null, set it based on campaign_type
...
-- ========================================
-- STEP 3: Set default values for niche and business_type
-- ========================================
...
-- ========================================
-- STEP 4: Now insert the default templates safely
-- ========================================
...
BEGIN
    ...
    RAISE NOTICE 'Added missing columns: name, niche, business_type, is_default, is_active, created_at, updated_at';
