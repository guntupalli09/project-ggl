...
-- 9. Insert Default Niche Templates
INSERT INTO email_templates (user_id, name, niche, campaign_type, subject_template, content_template, is_default, variables) VALUES
-- Salon Templates
(NULL, 'Salon Review Request', 'salon', 'review_request', 
...
(NULL, 'Salon Re-engagement', 'salon', 're_engagement',
...
-- Med Spa Templates
(NULL, 'Med Spa Review Request', 'medspa', 'review_request',
...
(NULL, 'Med Spa Educational', 'medspa', 'educational',
...
(NULL, 'Real Estate Market Update', 'realestate', 'market_update',
...
(NULL, 'Real Estate Open House', 'realestate', 'open_house',
...
(NULL, 'Home Services Review Request', 'home_services', 'review_request',
...
(NULL, 'Home Services Maintenance Reminder', 'home_services', 'maintenance_reminder',
