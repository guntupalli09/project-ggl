-- Working Email System Setup (Compatible with your existing database)
-- This creates the email system using your existing database structure
...
-- ========================================
-- STEP 3: Create Email Templates Table (Simplified)
-- ========================================
...
CREATE TABLE IF NOT EXISTS email_templates (
  ...
  user_id UUID REFERENCES auth.users(id) ON DELETE CASCADE,
  name TEXT NOT NULL,
  business_type TEXT NOT NULL, -- Using business_type instead of niche
  campaign_type TEXT NOT NULL,
...
-- ========================================
-- STEP 8: Insert Default Templates (Using business_type instead of niche)
-- ========================================

-- Insert default email templates (without user_id for global templates)
INSERT INTO email_templates (name, business_type, campaign_type, subject_template, content_template, is_default, variables) VALUES
-- Salon Templates
...
COMMENT ON TABLE email_templates IS 'Business-type specific email templates with personalization variables';
...
BEGIN
    ...
    RAISE NOTICE 'Using business_type instead of niche for compatibility';
END $$;
