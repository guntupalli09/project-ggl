-- Minimal Calendar Integration Setup
-- This version only adds the essential columns that exist in the automations table

-- Step 1: Add only the essential columns to automations table
ALTER TABLE automations ADD COLUMN IF NOT EXISTS type TEXT DEFAULT 'followup';
