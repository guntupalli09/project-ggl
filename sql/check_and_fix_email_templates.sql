-- Check email_templates table structure and fix it properly
-- This script first shows the actual structure, then fixes it
...
-- ========================================
-- STEP 4: Now insert the default templates safely with the correct column structure
-- ========================================

-- Insert default templates only if they don't already exist
-- Using only the columns that actually exist
INSERT INTO email_templates (template_name, template_type, subject, niche, business_type, campaign_type, subject_template, content_template, is_default, variables) 
SELECT * FROM (VALUES
-- Salon Templates
...
) AS v(template_name, template_type, subject, niche, business_type, campaign_type, subject_template, content_template, is_default, variables)
WHERE NOT EXISTS (
