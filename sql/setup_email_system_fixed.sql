-- Complete Email System Setup Script (FIXED VERSION)
-- This script sets up the entire email marketing system using auth.users instead of profiles

-- ========================================
-- STEP 1: Create Email Workflows Table
-- ========================================

-- Create email_workflow_settings table (using auth.users instead of profiles)
