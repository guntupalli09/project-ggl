-- Complete database fix - run this now that automations constraint is fixed
...
-- 5. Add missing columns to automations table
DO $$ 
BEGIN
...
-- 8. Fix user_settings unique constraint
DO $$ 
BEGIN
...
-- 9. Create RLS policies for brand_voice
DO $$ 
BEGIN
