-- Complete fix for email_templates table structure
-- This script handles all NOT NULL constraints and missing columns
...
INSERT INTO email_templates (template_name, template_type, niche, business_type, campaign_type, subject_template, content_template, is_default, variables) 
SELECT * FROM (VALUES
-- Salon Templates
('Salon Review Request', 'review_request', 'beauty', 'salon', 'review_request', 
...
('Salon Re-engagement', 're_engagement', 'beauty', 'salon', 're_engagement',
...
-- Med Spa Templates
('Med Spa Review Request', 'review_request', 'healthcare', 'medspa', 'review_request',
...
('Med Spa Treatment Plan', 'treatment_plan', 'healthcare', 'medspa', 'treatment_plan',
...
('Real Estate Market Update', 'market_update', 'real_estate', 'realestate', 'market_update',
...
('Real Estate Open House', 'open_house', 'real_estate', 'realestate', 'open_house',
...
('Home Services Review Request', 'review_request', 'home_services', 'homeservices', 'review_request',
...
('Home Services Maintenance Reminder', 'maintenance_reminder', 'home_services', 'homeservices', 'maintenance_reminder',
...
('Restaurant Review Request', 'review_request', 'food_service', 'restaurant', 'review_request',
...
-- Retail Templates
('Retail Review Request', 'review_request', 'retail', 'retail', 'review_request',
...
) AS v(template_name, template_type, niche, business_type, campaign_type, subject_template, content_template, is_default, variables)
WHERE NOT EXISTS (
...
BEGIN
    ...
    RAISE NOTICE 'Updated existing records with proper template_name and template_type values';
